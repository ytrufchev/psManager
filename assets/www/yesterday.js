...
$.ajax(settings).done(function (response) {
  ...
  "data": 'type=Android&interval=1&period=yesterday&token='+localStorage.getItem("token")
}
$.ajax(settings).done(function (response) { 
...
var settings = {
  ...
  "data": 'type=clicks&period=yesterday&token='+localStorage.getItem("token")
}
$.ajax(settings).done(function (response) {
  ...
  clickDataPoints[parseInt(hourNew)] = (clickDataPoints[parseInt(hourNew)] + 1);
  }
});
